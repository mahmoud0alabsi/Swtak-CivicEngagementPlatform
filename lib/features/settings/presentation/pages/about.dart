          ...
          child: Padding(
            ...
            child: Column(
              ...
              thickness: 1,
                ...
                SizedBox(height: 8),
                Text(
                  "تطبيق صوت المواطن يهدف إلى تعزيز المشاركة الشعبية في عملية اتخاذ القرارات عبر توفير منصة رقمية تتيح للمواطنين الأردنيين التعبير عن آرائهم والتصويت على القضايا التي يناقشها البرلمان أو المشاريع المقترحة من قبل البلديات. يسعى التطبيق لتحقيق شفافية أكبر وتواصل مباشر بين المواطنين وصناع القرار.",
