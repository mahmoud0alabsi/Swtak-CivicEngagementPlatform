                  ...
                  RichText(
                    ...
                    text: TextSpan(
                      children: [
                        ...
                        TextSpan(
                          text:
                              'كل مشروع يتم طرح للنقاش يؤثر على حياتنا اليومية، ومن خلال هذا التطبيق، '
                              'يمكنك أن تكون جزءًا من هذه العملية، عبر قراءة المعلومات المتاحة عن المشاريع المطروحة، ثم '
                              'استخدام حقك في التصويت لتقديم وجهة نظرك حولها.',
                          style: TextStyle(
                            color: Theme.of(context).colorScheme.primary,
                            fontSize: 10,
