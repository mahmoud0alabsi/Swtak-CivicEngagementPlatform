...
class MunicipalityVotingStatisticsPage extends StatelessWidget {
  const MunicipalityVotingStatisticsPage({super.key});
        ...
        child: ListView(
          children: [
            ...
            _buildTotalVotesCard(
                'إجمالي عدد الأصوات', 'منذ 01-10-2024', '3428', context),
            const SizedBox(height: 10),
            // Total Votes Card
            _buildTotalVotesCard('إجمالي المشاريع المرفوعة للتصويت',
                'منذ 01-10-2024', '16', context),
            const SizedBox(height: 10),
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            'تُقدِّم هذه الصفحة إحصائيات مفصلة حول التصويت  في مجالس البلديات. توفر الصفحة رؤية شاملة للإحصائيات المتعلقة بالتصويت، بما في ذلك توزيع الأصوات حسب البلديات والفئات العمرية الجنس وغيرها. تهدف هذه المعلومات إلى تمكين المستخدمين من فهم أنماط التصويت والمشاركة بشكل أعمق، استنادًا إلى البيانات المتنوعة المعروضة.',
            style: TextStyle(
              fontSize: 14,
              color: Theme.of(context).colorScheme.secondary,
            ),
  ...
  Widget _buildTotalVotesCard(
      String title, String date, String number, BuildContext context) {
    return Card(
      color: Theme.of(context).colorScheme.surfaceContainer,
                ...
                Column(
                  children: [
                    Container(
                      ...
                      decoration: const BoxDecoration(
                        shape: BoxShape.circle,
                        color: Color(0xFFD90429), // Red for male
                      ),
                      child: const Center(
                        child: Text(
        ...
        child: Column(
          ...
          children: [
            ...
            const Text(
              ...
              'تحديد أكثر المشاريع شعبية بين الجمهور في بلديتك.',
              style: TextStyle(
...
Widget buildAgeRangeStatsCard(BuildContext context) {
  ...
  final barColor = Theme.of(context).colorScheme.primary; // Extracted color
            ...
            series: [
              ColumnSeries<_ChartData, String>(
                ...
                dataLabelMapper: (data, _) =>
                    '${data.value}%', // Append % symbol
                color: barColor, // Using the color defined earlier
              ),
            ],
          ),
        ],
...
Widget _buildRegionalBreakdownCard(BuildContext context) {
  List<_PieData> data = [
    _PieData('إربد الكبرى', 45, Theme.of(context).colorScheme.secondary),
    _PieData('الشوبك الجديدة', 35,
        Theme.of(context).colorScheme.secondary.withBlue(120)),
    _PieData(
        'الموقر', 20, Theme.of(context).colorScheme.secondary.withBlue(160)),
  ];
  ...
  return Card(
    ...
    child: Padding(
      ...
      child: Column(
        ...
        children: [
          Text(
            'توزيع البلديات حسب اقتراح المشاريع',
            style: TextStyle(
              fontWeight: FontWeight.bold,
              color: Theme.of(context).colorScheme.secondary,
              fontSize: 16,
          ...
          const SizedBox(height: 16),
          const Text(
            'تعرض هذه البطاقة رسمًا دائريًا يوضح توزيع البلديات التي قدمت أعلى عدد من اقتراحات المشاريع للتصويت. يتيح هذا العرض لك معرفة البلديات الأكثر نشاطًا في طرح المشاريع، مما يعزز التفاعل والمشاركة في اتخاذ القرارات المتعلقة بتنمية المناطق.',
            style: TextStyle(
              color: Color.fromARGB(255, 134, 134, 134),
              fontSize: 14,
            ),
