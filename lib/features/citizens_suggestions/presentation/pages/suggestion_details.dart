...
class SuggestionDetailsPage extends StatefulWidget {
  ...
  @override
  SuggestionDetailsPageState createState() => SuggestionDetailsPageState();
}

class SuggestionDetailsPageState extends State<SuggestionDetailsPage> {
