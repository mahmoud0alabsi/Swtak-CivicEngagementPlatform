...
import 'package:citizens_voice_app/features/citizens_suggestions/presentation/pages/municipality_suggestion_details.dart';
import 'package:flutter/material.dart';
import 'package:flutter_bloc/flutter_bloc.dart';
import 'package:flutter_svg/flutter_svg.dart';

class MunicipalitySuggestionCard extends StatefulWidget {
  final MunicipalitySuggestionsBloc bloc;
  final MunicipalitySuggestionEntity suggestion;

  const MunicipalitySuggestionCard({
    super.key,
    required this.bloc,
  ...
  @override
  MunicipalitySuggestionCardState createState() =>
      MunicipalitySuggestionCardState();
}

class MunicipalitySuggestionCardState
    extends State<MunicipalitySuggestionCard> {
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  GestureDetector(
                    onTap: () {
                      context.read<MunicipalitySuggestionsBloc>().add(
